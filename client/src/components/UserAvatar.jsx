...
const UserAvatar = () => {
  ...
  // Updated the logic for user name handling
  const getInitials = (name) => {
    if (!name) return "U"; // fallback to "U" for unknown
    return name
      .split(" ")
      .map((n) => n[0]?.toUpperCase() || "") // safely access toUpperCase
      .join("");
  };
